...
* bodySite.coding = $sctno#7569003 "Finger"
* method = $sctno#37931006 "Auskultasjon"
* component[SystolicBP].code.coding[SBPCode] = $loinc#8480-6 "Systolic blood pressure"
* component[SystolicBP].code.coding[SystolicSnomed] = $sctno#4471000202106 "Systolic blood pressure"
...
* component[DiastolicBP].code.coding[DiastolicBPSnomed] = $sctno#4481000202108 "Diastolic blood pressure"
...
* component[MeanArterialPressure].code.coding[MAPSnomedCode] = $sctno#4501000202102 "Mean arterial pressure (observable entity)"
